...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_view_view_component__ = __webpack_require__("../../../../../src/app/components/view/view.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_save_save_component__ = __webpack_require__("../../../../../src/app/components/save/save.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    { path: 'view', component: __WEBPACK_IMPORTED_MODULE_17__components_view_view_component__["a" /* ViewComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_6__guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'save', component: __WEBPACK_IMPORTED_MODULE_18__components_save_save_component__["a" /* SaveComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_6__guards_auth_guard__["a" /* AuthGuard */]] },
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_17__components_view_view_component__["a" /* ViewComponent */],
                __WEBPACK_IMPORTED_MODULE_18__components_save_save_component__["a" /* SaveComponent */]
            ],
            // Modules
            imports: [
...
module.exports = "<div id=\"dashboard\" *ngIf=\"user\">\n  <p></p>\n  <h2 class=\"page-header\">Welcome, {{user.name}}!</h2>\n  <p></p>\n  <p>Chose what you want to do with you location:</p>\n  <a class=\"btn btn-info\" [routerLink]=\"['/save']\" id=\"save-button\">Record</a>\n  <a class=\"btn btn-success\" [routerLink]=\"['/view']\" id=\"view-button\">View</a>\n</div>"
...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>Tacker</h1>\n  <p class=\"lead\">Welcome to Tracker, an app to track your past self!</p>\n  <div *ngIf=\"!authService.loggedIn()\">\n    <a class=\"btn btn-success\" [routerLink]=\"['/register']\" id=\"register-button\">Register</a>\n    <a class=\"btn btn-info\" [routerLink]=\"['/login']\" id=\"login-button\">Login</a>\n  </div>\n</div>"
...
module.exports = "<h2 class=\"page-header\" id=\"login-header\">Login</h2>\n<form (submit)=\"onLoginSubmit()\">\n  <div class=\"form-group\">\n    <label>Username</label>\n    <input type=\"text\" class=\"form-control\" [(ngModel)]=\"username\" name=\"username\">\n  </div>\n  <div class=\"form-group\">\n    <label>Password</label>\n    <input type=\"password\" class=\"form-control\" [(ngModel)]=\"password\" name=\"password\">\n  </div>\n  <input type=\"submit\" class=\"btn btn-success\" value=\"login\" id=\"login-submit\">\n</form>"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessages.show("You're now logged in", { cssClass: "alert-success", timeOut: 3000 });
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.onLogoutClick = function () {
        ...
        this.flashMessages.show("You're now logged out", { cssClass: "alert-success", timeOut: 3000 });
...
module.exports = "<h2 class=\"page-header\" id=\"register-header\">Register</h2>\n<form (submit)=\"onRegisterSubmit()\">\n  <div class=\"form-group\">\n    <label>Name</label>\n    <input type=\"text\" [(ngModel)]=\"name\" name=\"name\" class=\"form-control\">\n  </div>\n  <div class=\"form-group\">\n    <label>Username</label>\n    <input type=\"text\" [(ngModel)]=\"username\" name=\"username\" class=\"form-control\">\n  </div>\n  <div class=\"form-group\">\n    <label>Email</label>\n    <input type=\"text\" [(ngModel)]=\"email\" name=\"email\" class=\"form-control\">\n  </div>\n  <div class=\"form-group\">\n    <label>Password</label>\n    <input type=\"password\" [(ngModel)]=\"password\" name=\"password\" class=\"form-control\">\n  </div>\n  <input type=\"submit\" class=\"btn btn-success\" value=\"submit\" id=\"register-submit\">\n</form>"
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessages.show("You're now registered and can login", { cssClass: "alert-success", timeOut: 3000 });
                _this.router.navigate(["/login"]);
            }
            else {
                _this.flashMessages.show(data.msg, { cssClass: "alert-danger", timeOut: 3000 });
...
/***/ "../../../../../src/app/components/save/save.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
var SaveComponent = /** @class */ (function () {
    function SaveComponent(authService, validateService, router) {
        this.authService = authService;
        this.validateService = validateService;
        this.router = router;
        this.delay = 1000;
    ...
    SaveComponent.prototype.ngOnInit = function () {
        ...
        this.authService.timer = setInterval(function () {
            var location = {
    ...
    SaveComponent.prototype.getLocation = function () {
        var _this = this;
    ...
    SaveComponent.prototype.stopRecording = function () {
        clearInterval(this.authService.timer);
        this.recording = false;
    ...
    SaveComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-save',
            template: __webpack_require__("../../../../../src/app/components/save/save.component.html"),
            styles: [__webpack_require__("../../../../../src/app/components/save/save.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_auth_service__["a" /* AuthService */],
...
var ViewComponent = /** @class */ (function () {
    function ViewComponent(authService, router) {
        this.authService = authService;
        this.router = router;
    ...
    ViewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.getLocation().subscribe(function (location) {
            _this.location = location.location;
        }, function (err) {
            console.log(err);
            return false;
        });
...
var AuthService = /** @class */ (function () {
    function AuthService(http) {
        this.http = http;
        this.apiKey = "qKV4qBykvFmdVVpUcQ1w";
    }
    AuthService.prototype.recordLocation = function (location) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append("Content-Type", "application/json");
        var url = "users/record/" + this.apiKey;
    ...
    AuthService.prototype.registerUser = function (user) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append("Content-Type", "application/json");
        var url = "users/register/" + this.apiKey;
    ...
    AuthService.prototype.authenticateUser = function (user) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append("Content-Type", "application/json");
        var url = "users/authenticate/" + this.apiKey;
        return this.http.post(url, user, { headers: headers }).map(function (res) {
            return res.json();
        });
    };
    AuthService.prototype.getProfile = function () {
        ...
        headers.append("Content-Type", "application/json");
        var url = "users/profile/" + this.apiKey;
